package mx.lania.mca.g4d.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, mx.lania.mca.g4d.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, mx.lania.mca.g4d.repository.UserRepository.USERS_BY_EMAIL_CACHE);
