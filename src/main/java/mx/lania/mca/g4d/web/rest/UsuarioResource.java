...
import mx.lania.mca.g4d.repository.UsuarioRepository;
import mx.lania.mca.g4d.service.UsuarioService;
...
/**
 * REST controller for managing {@link mx.lania.mca.g4d.domain.Usuario}.
 */
@RestController
@RequestMapping("/api")
public class UsuarioResource {
     ...
     */
    @GetMapping("/usuarios")
    public ResponseEntity<List<UsuarioDTO>> getAllUsuarios(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
