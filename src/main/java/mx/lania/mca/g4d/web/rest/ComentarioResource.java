...
import mx.lania.mca.g4d.service.ComentarioService;
...
/**
 * REST controller for managing {@link mx.lania.mca.g4d.domain.Comentario}.
 */
@RestController
@RequestMapping("/api")
public class ComentarioResource {
    ...
    public ResponseEntity<ComentarioDTO> updateComentario(
        ...
        ComentarioDTO result = comentarioService.update(comentarioDTO);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<ComentarioDTO> partialUpdateComentario(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody ComentarioDTO comentarioDTO
    ) throws URISyntaxException {
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, comentarioDTO.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<ComentarioDTO>> getAllComentarios(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
