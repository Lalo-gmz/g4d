...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, mx.lania.g4d.domain.Usuario.class.getName());
            createCache(cm, mx.lania.g4d.domain.Usuario.class.getName() + ".bitacoras");
            createCache(cm, mx.lania.g4d.domain.Usuario.class.getName() + ".comentarios");
            ...
            createCache(cm, mx.lania.g4d.domain.Permiso.class.getName());
            createCache(cm, mx.lania.g4d.domain.Rol.class.getName());
            createCache(cm, mx.lania.g4d.domain.Rol.class.getName() + ".usuarios");
            createCache(cm, mx.lania.g4d.domain.Rol.class.getName() + ".permisos");
            createCache(cm, mx.lania.g4d.domain.Proyecto.class.getName());
            createCache(cm, mx.lania.g4d.domain.Proyecto.class.getName() + ".rols");
            ...
            createCache(cm, mx.lania.g4d.domain.Proyecto.class.getName() + ".usuarios");
            ...
            createCache(cm, mx.lania.g4d.domain.Funcionalidad.class.getName() + ".usuarios");
            createCache(cm, mx.lania.g4d.domain.Funcionalidad.class.getName() + ".atributos");
