    ...
    public Optional<Usuario> partialUpdate(Usuario usuario) {
        ...
        return usuarioRepository
            ...
            .map(existingUsuario -> {
                ...
                if (usuario.getIdGitLab() != null) {
                    existingUsuario.setIdGitLab(usuario.getIdGitLab());
                }
                if (usuario.getTokenIdentificacion() != null) {
                    existingUsuario.setTokenIdentificacion(usuario.getTokenIdentificacion());
                }
