...
describe('Rol routing resolve service', () => {
  ...
  let resultRol: IRol | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IRol returned by find', () => {
      ...
      expect(resultRol).toEqual({ id: 123 });
    });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultRol).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IRol>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
