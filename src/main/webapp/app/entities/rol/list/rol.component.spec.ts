...
describe('Rol Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'rol', component: RolComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to rolService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getRolIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getRolIdentifier).toHaveBeenCalledWith(entity);
