...
describe('Permiso Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'permiso', component: PermisoComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.permisos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to permisoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPermisoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPermisoIdentifier).toHaveBeenCalledWith(entity);
